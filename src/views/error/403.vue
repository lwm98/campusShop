<template>
  <div class="norole">
    ...
    <div class="error">
      ...
      <div class="error__subtitle">您没有进入该页面的权限....</div>
      <button class="error__button error__button--active">返回首页</button>
      <button class="error__button">联系我们</button>
    ...
    <div class="astronaut">
      ...
      <div class="astronaut__cord" style="overflow:hidden">
...
@font-face {
  ...
  src: local("Righteous"), local("Righteous-Regular"),
    url(https://fonts.gstatic.com/s/righteous/v8/1cXxaUPXBpj2rGoU7C9WhnGFucE.woff2)
      format("woff2");
...
@font-face {
  ...
  font-display: swap;
  src: local("Righteous"), local("Righteous-Regular"),
    url(https://fonts.gstatic.com/s/righteous/v8/1cXxaUPXBpj2rGoU7C9WiHGF.woff2)
      format("woff2");
